...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/4mangotrees/testing-repo/main)
...
git branch -M main
git remote add origin https://github.com/4mangotrees/testing-repo.git
